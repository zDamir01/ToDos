...
public class ToDoFrame extends javax.swing.JFrame {
    ...
    public ToDoFrame() {
        ...
        new String[] {"ID", "Naslov", "Opis", "Datum Kreiranja", "Rok Do", "Stanje", "Prikaz"}, 0);
        ...
        // Dodavanje button renderera za kolonu Stampanje
        jTable1.getColumnModel().getColumn(6).setCellRenderer(new ButtonRenderer());
        jTable1.getColumnModel().getColumn(6).setCellEditor(new ButtonEditor(new JButton()));
                
        btnPrikaziActionPerformed(null);
         
    }

    // Klasa za prikazivanje dugmeta u koloni
    ...
    // Klasa za obradu klika na dugme
    class ButtonEditor extends AbstractCellEditor implements TableCellEditor {
        ...
        private void stampajOdabraniToDo() {
            // Dohvati podatke iz selektovanog reda
            int id = Integer.parseInt(jTable1.getValueAt(selectedRow, 0).toString());
            String naslov = jTable1.getValueAt(selectedRow, 1).toString();
            String opis = jTable1.getValueAt(selectedRow, 2).toString();
            String stanje = jTable1.getValueAt(selectedRow, 5).toString();
            java.util.Date datumKreiranja = (java.util.Date) jTable1.getValueAt(selectedRow, 3);
            java.util.Date rokDo = (java.util.Date) jTable1.getValueAt(selectedRow, 4);
            int userID = Sesija.getUlogovaniKorisnik().ID;
            
            // Kreiraj ToDoModel objekat i pozovi metodu stampajToDo()
            ToDoModel todo = new ToDoModel(id, naslov, opis, stanje, datumKreiranja, rokDo, userID);
            todo.stampajToDo();
        }
...
// DA SE IZMENI I AKO MOZE DA SE OVO UPROSTI ??
    /**
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Naslov", "Opis", "Datum Kreiranja", "Rok Do", "Stanje", "Stampanje"
            }
        ));
